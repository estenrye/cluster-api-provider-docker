...
import (
	...
	infrastructurev1alpha1 "github.com/estenrye/cluster-api-provider-docker/api/v1alpha1"
	"github.com/estenrye/cluster-api-provider-docker/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "c7bf28fe.cluster.x-k8s.io",
